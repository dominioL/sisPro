...
@Path("/cadastroDePessoaFisica")
public final class RecursoCadastroDePessoaFisica {
	
	@GET
	@Produces(TipoDeMidia.HTML)
	public Response obterHtmlPessoaFisica() {
		...
		return new ModeloDeRecursoDePaginaHtml().obterHtml(ArquivoHtml.CADASTRO_DE_PESSOA_FISICA, ArquivoHtml.MENU_CLIENTES, clientesJson);
	}
}
